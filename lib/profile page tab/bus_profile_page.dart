...
import '../pages/mainpages/sub_page/edit_bus_profile.dart';
import '../pages/mainpages/sub_page/get_bus_profile.dart';
import '../pages/mainpages/sub_page/get_probus_details.dart';
                              ...
                              GestureDetector(
                                onTap: (){
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => const GetBusProfilePage()),
                                  );
                                },
                                child: Container(
                                  height: 70,

...
import 'package:pro_bus_app/pages/mainpages/sub_page/home_button/view_booking_list.dart';
import 'package:pro_bus_app/pages/mainpages/sub_page/home_button/view_bus_list.dart';

class HomeBookingButton extends StatefulWidget {
  const HomeBookingButton({Key? key}) : super(key: key);

  @override
  State<HomeBookingButton> createState() => _HomeBookingButtonState();
}

class _HomeBookingButtonState extends State<HomeBookingButton> {
  String searchValue = '';
                          ...
                          return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: GetBookingview(documentId: docIDS[index]),
                                );
                              });
                        },
                      ),
